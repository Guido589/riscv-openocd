...
DECLARE_CSR(entrycfg0, CSR_ENTRYCFG0)
DECLARE_CSR(entrycfg1, CSR_ENTRY_CFG1)
DECLARE_CSR(entrycfg2, CSR_ENTRYCFG2)
DECLARE_CSR(entrycfg3, CSR_ENTRYCFG3)
DECLARE_CSR(entrycfg4, CSR_ENTRYCFG4)
DECLARE_CSR(entrycfg5, CSR_ENTRYCFG5)
DECLARE_CSR(entrycfg6, CSR_ENTRYCFG6)
DECLARE_CSR(entrycfg7, CSR_ENTRYCFG7)
DECLARE_CSR(entrycfg8, CSR_ENTRYCFG8)
DECLARE_CSR(entrycfg9, CSR_ENTRYCFG9)
DECLARE_CSR(entrycfg10, CSR_ENTRYCFG10)
DECLARE_CSR(entrycfg11, CSR_ENTRYCFG11)
DECLARE_CSR(entrycfg12, CSR_ENTRYCFG12)
DECLARE_CSR(entrycfg13, CSR_ENTRYCFG13)
DECLARE_CSR(entrycfg14, CSR_ENTRYCFG14)
DECLARE_CSR(entrycfg15, CSR_ENTRYCFG15)
#endif
#ifdef DECLARE_CAUSE
