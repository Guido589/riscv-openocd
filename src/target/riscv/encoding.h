...
#define CSR_MDCFG1 0x804
#define CSR_MDCFG2 0x808
#define CSR_MDCFG3 0x80c
#define CSR_MDCFG4 0x810
#define CSR_MDCFG5 0x814
#define CSR_MDCFG6 0x818
#define CSR_MDCFG7 0x81c
#define CSR_MDCFG8 0x820
#define CSR_MDCFG9 0x824
#define CSR_MDCFG10 0x828
#define CSR_MDCFG11 0x82c
#define CSR_MDCFG12 0x830
#define CSR_MDCFG13 0x834
#define CSR_MDCFG14 0x838
#define CSR_MDCFG15 0x83c
#define CSR_MDCFG16 0x840
#define CSR_MDCFG17 0x844
#define CSR_MDCFG18 0x848
#define CSR_MDCFG19 0x84c
#define CSR_MDCFG20 0x850
#define CSR_MDCFG21 0x854
#define CSR_MDCFG22 0x858
#define CSR_MDCFG23 0x85c
#define CSR_MDCFG24 0x860
#define CSR_MDCFG25 0x864
#define CSR_MDCFG26 0x868
#define CSR_MDCFG27 0x86c
#define CSR_MDCFG28 0x870
#define CSR_MDCFG29 0x874
#define CSR_MDCFG30 0x878
#define CSR_MDCFG31 0x87c
#define CSR_MDCFG32 0x880
#define CSR_MDCFG33 0x884
#define CSR_MDCFG34 0x888
#define CSR_MDCFG35 0x88c
#define CSR_MDCFG36 0x890
#define CSR_MDCFG37 0x894
#define CSR_MDCFG38 0x898
#define CSR_MDCFG39 0x89c
#define CSR_MDCFG40 0x8a0
#define CSR_MDCFG41 0x8a4
#define CSR_MDCFG42 0x8a8
#define CSR_MDCFG43 0x8ac
#define CSR_MDCFG44 0x8b0
#define CSR_MDCFG45 0x8b4
#define CSR_MDCFG46 0x8b8
#define CSR_MDCFG47 0x8bc
#define CSR_MDCFG48 0x8c0
#define CSR_MDCFG49 0x8c4
#define CSR_MDCFG50 0x8c8
#define CSR_MDCFG51 0x8cc
#define CSR_MDCFG52 0x8d0
#define CSR_MDCFG53 0x8d4
#define CSR_MDCFG54 0x8d8
#define CSR_MDCFG55 0x8dc
#define CSR_MDCFG56 0x8e0
...
#define CSR_ENTRY_ADDR1 0x1440
#define CSR_ENTRY_CFG1  0x1448
#define CSR_ENTRY_ADDR2 0x1450
#define CSR_ENTRY_CFG2  0x1458
#define CSR_ENTRY_ADDR3 0x1460
#define CSR_ENTRY_CFG3  0x1468
#define CSR_ENTRY_ADDR4 0x1470
#define CSR_ENTRY_CFG4  0x1478
#define CSR_ENTRY_ADDR5 0x1480
#define CSR_ENTRY_CFG5  0x1488
#define CSR_ENTRY_ADDR6 0x1490
#define CSR_ENTRY_CFG6  0x1498
#define CSR_ENTRY_ADDR7 0x14a0
#define CSR_ENTRY_CFG7  0x14a8
#define CSR_ENTRY_ADDR8 0x14b0
#define CSR_ENTRY_CFG8  0x14b8
#define CSR_ENTRY_ADDR9 0x14c0
#define CSR_ENTRY_CFG9  0x14c8
#define CSR_ENTRY_ADDR10 0x14d0
#define CSR_ENTRY_CFG10  0x14d8
#define CSR_ENTRY_ADDR11 0x14e0
#define CSR_ENTRY_CFG11  0x14e8
#define CSR_ENTRY_ADDR12 0x14f0
#define CSR_ENTRY_CFG12  0x14f8
#define CSR_ENTRY_ADDR13 0x1500
#define CSR_ENTRY_CFG13  0x1508
#define CSR_ENTRY_ADDR14 0x1510
#define CSR_ENTRY_CFG14  0x1518
#define CSR_ENTRY_ADDR15 0x1520
#define CSR_ENTRY_CFG15  0x1528
...
DECLARE_CSR(mdcfg0, CSR_MDCFG0)
DECLARE_CSR(mdcfg1, CSR_MDCFG1)
DECLARE_CSR(mdcfg2, CSR_MDCFG2)
DECLARE_CSR(mdcfg3, CSR_MDCFG3)
DECLARE_CSR(mdcfg4, CSR_MDCFG4)
DECLARE_CSR(mdcfg5, CSR_MDCFG5)
DECLARE_CSR(mdcfg6, CSR_MDCFG6)
DECLARE_CSR(mdcfg7, CSR_MDCFG7)
DECLARE_CSR(mdcfg8, CSR_MDCFG8)
DECLARE_CSR(mdcfg9, CSR_MDCFG9)
DECLARE_CSR(mdcfg10, CSR_MDCFG10)
DECLARE_CSR(mdcfg11, CSR_MDCFG11)
DECLARE_CSR(mdcfg12, CSR_MDCFG12)
DECLARE_CSR(mdcfg13, CSR_MDCFG13)
DECLARE_CSR(mdcfg14, CSR_MDCFG14)
DECLARE_CSR(mdcfg15, CSR_MDCFG15)
DECLARE_CSR(mdcfg16, CSR_MDCFG16)
DECLARE_CSR(mdcfg17, CSR_MDCFG17)
DECLARE_CSR(mdcfg18, CSR_MDCFG18)
DECLARE_CSR(mdcfg19, CSR_MDCFG19)
DECLARE_CSR(mdcfg20, CSR_MDCFG20)
DECLARE_CSR(mdcfg21, CSR_MDCFG21)
DECLARE_CSR(mdcfg22, CSR_MDCFG22)
DECLARE_CSR(mdcfg23, CSR_MDCFG23)
DECLARE_CSR(mdcfg24, CSR_MDCFG24)
DECLARE_CSR(mdcfg25, CSR_MDCFG25)
DECLARE_CSR(mdcfg26, CSR_MDCFG26)
DECLARE_CSR(mdcfg27, CSR_MDCFG27)
DECLARE_CSR(mdcfg28, CSR_MDCFG28)
DECLARE_CSR(mdcfg29, CSR_MDCFG29)
DECLARE_CSR(mdcfg30, CSR_MDCFG30)
DECLARE_CSR(mdcfg31, CSR_MDCFG31)
DECLARE_CSR(mdcfg32, CSR_MDCFG32)
DECLARE_CSR(mdcfg33, CSR_MDCFG33)
DECLARE_CSR(mdcfg34, CSR_MDCFG34)
DECLARE_CSR(mdcfg35, CSR_MDCFG35)
DECLARE_CSR(mdcfg36, CSR_MDCFG36)
DECLARE_CSR(mdcfg37, CSR_MDCFG37)
DECLARE_CSR(mdcfg38, CSR_MDCFG38)
DECLARE_CSR(mdcfg39, CSR_MDCFG39)
DECLARE_CSR(mdcfg40, CSR_MDCFG40)
DECLARE_CSR(mdcfg41, CSR_MDCFG41)
DECLARE_CSR(mdcfg42, CSR_MDCFG42)
DECLARE_CSR(mdcfg43, CSR_MDCFG43)
DECLARE_CSR(mdcfg44, CSR_MDCFG44)
DECLARE_CSR(mdcfg45, CSR_MDCFG45)
DECLARE_CSR(mdcfg46, CSR_MDCFG46)
DECLARE_CSR(mdcfg47, CSR_MDCFG47)
DECLARE_CSR(mdcfg48, CSR_MDCFG48)
DECLARE_CSR(mdcfg49, CSR_MDCFG49)
DECLARE_CSR(mdcfg50, CSR_MDCFG50)
DECLARE_CSR(mdcfg51, CSR_MDCFG51)
DECLARE_CSR(mdcfg52, CSR_MDCFG52)
DECLARE_CSR(mdcfg53, CSR_MDCFG53)
DECLARE_CSR(mdcfg54, CSR_MDCFG54)
DECLARE_CSR(mdcfg55, CSR_MDCFG55)
DECLARE_CSR(mdcfg56, CSR_MDCFG56)
DECLARE_CSR(mdcfg57, CSR_MDCFG57)
DECLARE_CSR(mdcfg58, CSR_MDCFG58)
DECLARE_CSR(mdcfg59, CSR_MDCFG59)
DECLARE_CSR(mdcfg60, CSR_MDCFG60)
DECLARE_CSR(mdcfg61, CSR_MDCFG61)
DECLARE_CSR(mdcfg62, CSR_MDCFG62)
DECLARE_CSR(srcmd0, CSR_SRCMD0)
DECLARE_CSR(srcmd1, CSR_SRCMD1)
DECLARE_CSR(srcmd2, CSR_SRCMD2)
DECLARE_CSR(srcmd3, CSR_SRCMD3)
DECLARE_CSR(srcmd4, CSR_SRCMD4)
DECLARE_CSR(srcmd5, CSR_SRCMD5)
DECLARE_CSR(srcmd6, CSR_SRCMD6)
DECLARE_CSR(srcmd7, CSR_SRCMD7)
DECLARE_CSR(srcmd8, CSR_SRCMD8)
DECLARE_CSR(srcmd9, CSR_SRCMD9)
DECLARE_CSR(srcmd10, CSR_SRCMD10)
DECLARE_CSR(srcmd11, CSR_SRCMD11)
DECLARE_CSR(srcmd12, CSR_SRCMD12)
DECLARE_CSR(srcmd13, CSR_SRCMD13)
DECLARE_CSR(srcmd14, CSR_SRCMD14)
DECLARE_CSR(srcmd15, CSR_SRCMD15)
DECLARE_CSR(entry_addr0, CSR_ENTRY_ADDR0)
DECLARE_CSR(entry_addr1, CSR_ENTRY_ADDR1)
DECLARE_CSR(entry_addr2, CSR_ENTRY_ADDR2)
DECLARE_CSR(entry_addr3, CSR_ENTRY_ADDR3)
DECLARE_CSR(entry_addr4, CSR_ENTRY_ADDR4)
DECLARE_CSR(entry_addr5, CSR_ENTRY_ADDR5)
DECLARE_CSR(entry_addr6, CSR_ENTRY_ADDR6)
DECLARE_CSR(entry_addr7, CSR_ENTRY_ADDR7)
DECLARE_CSR(entry_addr8, CSR_ENTRY_ADDR8)
DECLARE_CSR(entry_addr9, CSR_ENTRY_ADDR9)
DECLARE_CSR(entry_addr10, CSR_ENTRY_ADDR10)
DECLARE_CSR(entry_addr11, CSR_ENTRY_ADDR11)
DECLARE_CSR(entry_addr12, CSR_ENTRY_ADDR12)
DECLARE_CSR(entry_addr13, CSR_ENTRY_ADDR13)
DECLARE_CSR(entry_addr14, CSR_ENTRY_ADDR14)
DECLARE_CSR(entry_addr15, CSR_ENTRY_ADDR15)
DECLARE_CSR(entry_cfg0, CSR_ENTRY_CFG0)
DECLARE_CSR(entry_cfg1, CSR_ENTRY_CFG1)
DECLARE_CSR(entry_cfg2, CSR_ENTRY_CFG2)
DECLARE_CSR(entry_cfg3, CSR_ENTRY_CFG3)
DECLARE_CSR(entry_cfg4, CSR_ENTRY_CFG4)
DECLARE_CSR(entry_cfg5, CSR_ENTRY_CFG5)
DECLARE_CSR(entry_cfg6, CSR_ENTRY_CFG6)
DECLARE_CSR(entry_cfg7, CSR_ENTRY_CFG7)
DECLARE_CSR(entry_cfg8, CSR_ENTRY_CFG8)
DECLARE_CSR(entry_cfg9, CSR_ENTRY_CFG9)
DECLARE_CSR(entry_cfg10, CSR_ENTRY_CFG10)
DECLARE_CSR(entry_cfg11, CSR_ENTRY_CFG11)
DECLARE_CSR(entry_cfg12, CSR_ENTRY_CFG12)
DECLARE_CSR(entry_cfg13, CSR_ENTRY_CFG13)
DECLARE_CSR(entry_cfg14, CSR_ENTRY_CFG14)
DECLARE_CSR(entry_cfg15, CSR_ENTRY_CFG15)
#endif
#ifdef DECLARE_CAUSE
